...
func Redeem(key string, userId int) (quota int, err error) {
	...
	if err != nil {
		return 0, errors.New("RedeemFailure，" + err.Error())
	}
	RecordLog(userId, LogTypeTopup, fmt.Sprintf("Recharge %s through redemption code，Redeem CodeID %d", common.LogQuota(redemption.Quota), redemption.Id))
